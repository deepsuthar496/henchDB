...
- **Quality & Size Ceiling**: **216/216 tests passing** (149 engine + 67 server), release builds with zero warnings, and every source file is strictly under 1,500 lines (with `sql/`, `db/`, `wire/`, and `replication/` cleanly modularized).
...
1. `cargo test` — all green (**216 tests: 149 engine + 67 server** as of this writing).
