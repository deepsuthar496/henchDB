...
- **Quality & Size Ceiling**: **194/194 tests passing** (128 engine + 66 server), release builds with zero warnings, and every source file is strictly under 1,500 lines (with `sql/`, `db/`, `wire/`, and `replication/` cleanly modularized).
...
1. `cargo test` — all green (**194 tests: 128 engine + 66 server** as of this writing).
