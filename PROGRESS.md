...
- **Quality & Size Ceiling**: **205/205 tests passing** (138 engine + 67 server), release builds with zero warnings, and every source file is strictly under 1,500 lines (with `sql/`, `db/`, `wire/`, and `replication/` cleanly modularized).
...
1. `cargo test` — all green (**205 tests: 138 engine + 67 server** as of this writing).
