...
- **Quality & Size Ceiling**: **184/184 tests passing** (125 engine + 59 server), release builds with zero warnings, and every source file is strictly under 1,500 lines (with `sql/`, `db/`, and `wire/` cleanly modularized).
...
1. `cargo test` — all green (**184 tests: 125 engine + 59 server** as of this writing).
