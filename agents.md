...
crates/engine/src/
  ...
  db/                 Database facade split per §9 ceiling: mod (sessions,
                      ...
                      fk, txn, opt, subquery, sysviews, batch, privilege, memo)
