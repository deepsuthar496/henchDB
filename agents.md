...
crates/engine/src/
  ...
  db/                 Database facade split per §9 ceiling: mod (sessions,
                      ...
                      replica (read-only gate, WAL/snapshot apply),
